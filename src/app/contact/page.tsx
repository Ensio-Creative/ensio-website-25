export const metadata = {
  ...
  description: "Ready to take your brand or business further? Get in touch with our studio to discuss your next project."
};
...
const ContactPage = () => (
  <main className="bg-white min-h-screen text-black">
    ...
    <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:py-20 py-10 px-4 items-start">
      <h1 className="text-[50px] md:text-[70px] mb-8">LET’S TALK</h1>
